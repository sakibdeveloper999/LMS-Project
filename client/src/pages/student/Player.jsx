    ...
    <>
      <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
        ...
        <div className='text-gray-800'>
          <h2 className='text-xl font-samibold'>Course Structure</h2>
          <div className="pt-5">
          ...
          {playerData ? (
            <div className='w-full h-64 md:h-96'>
              ...
              <div className="flex justify-between items-center mt-1">
                ...
                <button className="bg-blue-500 text-white py-1 px-3 rounded-md hover:bg-blue-600">{false ? 'Completed': 'Mark Complete'}</button>
              </div>
            </div>
          ) : (
